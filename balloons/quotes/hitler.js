module.exports = [
  ...
  'Wenn manche sagen: »Sie sind ein Phantast!«, dann kann ich ihm nur antworten: »Sie Idiot!« Wenn ich nie in meinem Leben ein Phantast gewesen wäre, wo wären sie, und wo wären wir heute alle? Ich habe immer an die deutsche Zukunft geglaubt. Sie haben damals gesagt: »Sie sind ein Phantast!«',
  ...
  'Ich habe das Wort Blitzkrieg nie verwendet, weil es ein ganz blödsinniges Wort ist',
  'Ich habe nun damals alles umgestellt auf den Gedanken, Arbeitsleistung gegen Arbeitsleistung, Rohstoff gegen Arbeitsleistung, Produkte der Landwirtschaft gegen Produkte der Industrie. Es ist mir gelungen, in jahrelanger Arbeit allmählich eine gewiße Binnenwirtschaft wenigstens in Europa aufzubauen.',
  'Allein gegen diese Binnenwirtschaft begann sofort wieder der alte Kampf Englands, das in dieser Konsolidierung wirtschaflich gesehen, den Keim einer späteren politischen Zusammenarbeit fühlte.',
  ...
  'Das Gebot für die ganze Bewegung und das ganze Deutsche Volk, Danzig war Deutsch, Danzig ist Deutsch geblieben, Danzig wird von jetzt an Deutsch sein solange es ein Deutsches Volk gibt, oder ein Deutsches Reich. Generationen werden kommen und Generationen werden wieder vergehen, und sie alle werden zurückblicken auf die 20 Jahre der Abwesenheit dieser Stadt, als eine traurige Zeit in unserer Geschichte.',
  'Sie werden sich aber dann nicht erinnern der Schande des Jahres 1918, sondern werden sich mit Stolz entsinnen auf die Zeit der Deutschen Wiedererhebung, und der Wiederauferstehung des Deutschen Reiches, jenes Reiches das nun alle Deutschen Stämme zusammen gebracht hat, das sie zusammen fügte zu einer Einheit, und für das wir nun einzutreten entschlossen sind bis zum letzten Hauch',
  'Dieses Deutschland wir deutsche Volksgemeinschaft aller Deutschen Stämme, das Großdeutsche Reich, Sieg Heil!',
  ...
  'Denn denken Sie nicht, dass Sie eine Krankheit bekämpfen können, ohne nicht den Erreger töten, ohne den Bazillus zu vernichten, und denken Sie nicht, dass Sie die Rassentuberkulose bekämpfen können, ohne dafür zu sorgen, dass das Volk frei wird von dem Erreger der Rassentuberkulose',
  ...
  'Ich wünsche nicht, nach meinem Tode in einem russischen Panoptikum aufgestellt zu werden',
  'In diesem Krieg gibt es keine Zivilisten',
  'Je größer die Lüge, desto mehr Menschen folgen ihr',
  'Letztes Ziel aber muss unverrückbar die Entfernung der Juden überhaupt sein',
  'Luther war ein großer Mann, ein Riese. Mit einem Ruck durchbrach er die Dämmerung, sah den Juden, wie wir ihn erst heute zu sehen beginnen',
  'Man verhindere die jüdische Unterhöhlung unseres Volkes, wenn notwendig, durch die Sicherung ihrer Erreger in Konzentrationslagern',
  ...
  'Nach zehn Jahren Zuchthaus ist der Mensch sowieso für die Volksgemeinschaft verloren. Solchen Kerl steckt man entweder in ein Konzentrationslager oder tötet ihn. In letzter Zeit ist das Letztere wichtiger, um der Abschreckung willen',
  'Pius XII.? Dies ist der einzige Mensch, der mir immer widersprochen und niemals gehorcht hat',
  ...
  'Wenn das Judentum sich etwa einbildet, einen internationalen Weltkrieg zur Ausrottung der europäischen Rassen herbeiführen zu können, so wird das Ergebnis nicht die Ausrottung der europäischen Rassen, sondern die Ausrottung des Judentums in Europa sein.',
  'Sie haben mich immer als Propheten ausgelacht. Von denen, die damals lachten, lachen unzählige nicht mehr. Die jetzt noch lachen, werden in einiger Zeit vielleicht auch nicht mehr lachen. Diese Welle wird sich über Europa hinaus über die ganze Welt verbreiten',
