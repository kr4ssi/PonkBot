...
module.exports = {
  handlers: {
    ...
    rehost: function(user, params, meta) {
      ...
      if (!url) return this.sendMessage('Ist keine https-Elfe /pfräh /pfräh')
      rehostImage(url)
    },
    addemote: function(user, params, meta) {
      ...
      if (!image) return this.sendMessage('Ist keine https-Elfe /pfräh /pfräh')
      this.client.socket.emit('updateEmote', { name, image })
    },
  ...
  function logoHintergrund(user, params, meta) {
    ...
    if (params) {
      if (params != 'last') {
        ...
        if (!params) return this.sendMessage('Ist keine https-Elfe /pfräh /pfräh')
