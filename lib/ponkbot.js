...
class PonkBot extends EventEmitter {
        ...
        this.once('dbready', ()=>{
            this.createClient(config.sync)
                ...
                .once('connected', ()=>{
                    ...
                    require('../balloons/replacements.js')(this);
                    this.client.start();
    ...
    registerListeners(socket){
        ...
        */
        ...
        socket.once('channelCSSJS',  (cssjs)=>{ this.channelCSS = cssjs.css; this.channelJS = cssjs.js });
        socket.once('setMotd',  (motd)=>{ this.channelMotd = motd; });
