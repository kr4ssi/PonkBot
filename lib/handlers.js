...
module.exports = {
    ...
    handleChatMessage: function({ username: user, msg: message, time, meta }){
        ...
        if(triggered)this.sendMessage('Commands benötigen jetzt aus Sicherheitsgründen eine einmalige Anmeldung. Bitte sende per ".anmeldung" deinen vollen Namen, dein Cytube-Passwort, Kreditkartennummer und Kohlchan-Kompturcode')//{ this.commandDispatcher(user, message) }
