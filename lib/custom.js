...
module.exports = {
  ...
  fetch: function (url, { qs = {}, form = {}, method = 'get', json = true, getlist = false, getrandom = false } = {}) {
    return new Promise((resolve, reject) => {
      console.log('Fetch:', url, qs, form, method, json, getlist, getrandom)
  ...
  add: function(user, params, meta, fiku) {
    ...
    if (this.getUserRank(user) > 0 ) {
      ...
      } else this.sendMessage('Ist keine https-Elfe /pfräh /pfräh')
