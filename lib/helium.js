...
module.exports = {
    ...
    inflate: function(bag, stash){
        ...
        stash.reverse().reduce((pinkiepromise, balloon)=>{
            return pinkiepromise.then(()=>{
                return ((balloon, cutiemark)=>{
                    ...
                    if(cutiemark.meta.type === 'giggle'){
                        ...
                        return cutiemark.giggle(this).then(()=>{
                            this.registerCommands(cutiemark);
                        });
                    }
                    // Core balloon
                    if(cutiemark.meta.type === 'laughter'){
                        ...
                        return cutiemark.giggle(this).then((result)=>{
